...
public class ChatBot extends Keywords {
	...
	String MSSFoption = Utils.getDataFromTestData("Maruthi", "Excepted text5").trim();
...
//		String option = text.getText().trim();
//		System.out.println("Actual option : " + "\n" + option);
//
//		System.out.println("\nExcepted option : "+"\n" + MSSFoption);
//
//		if (option.contains(MSSFoption)) {
//			System.out.println("Actual response is matches with Excepted response for STEP1 is done");
//		} else {
